...
/TEMP/, /--+/ {
    ...
    if ($f ~ /KRC|KRD/) {
        ...
        if ($intTEMP > 71.00) {
            print\
                NN, $fFRU, $fBOARD, $fSERIAL, $fTEMP, longdate >> high_file_temp
        }
    }
}
